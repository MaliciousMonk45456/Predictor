...
const AddFile = () => {
    ...
    const fetchfile = async () => {
      try {
        const file = await sendRequest(
          ...
          process.env.REACT_APP_BACKEND_URI + "file/check",
          "GET",
          null,
          {
  ...
  const onsubmithandler = async (event) => {
    ...
    const responseData = await sendRequest(
      ...
      process.env.REACT_APP_BACKEND_URI + "file/upload",
      "POST",
      formData,
      {
        Authorization: "Bearer " + token,
  ...
  const clickHandler = async (event) => {
    ...
    const responseData = await sendRequest(
      ...
      process.env.REACT_APP_BACKEND_URI + `file/download/${fileId}`,
      "GET",
      null,
      {
        Authorization: "Bearer " + token,
  ...
  const handleDelete = async (event) => {
    ...
    await sendRequest(
      ...
      process.env.REACT_APP_BACKEND_URI + "file/delete",
      "DELETE",
      null,
      {
        Authorization: "Bearer " + token,
